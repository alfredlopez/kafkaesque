...
public class DefaultFileStoreService extends AbstractStoreService implements FileStoreService {
    private Logger logger                           = LoggerFactory.getLogger(DefaultFileStoreService.class);
    ...
    public DefaultFileStoreService(String storeName) {
        super(storeName);
    }
                    ...
                    if (versionListResult.succeeded()) {
                        try {
                            ...
                            if (!fileNames.isEmpty()) {
                                ...
                                InputStream latestFile = new FileInputStream(fileNames.get(0));
